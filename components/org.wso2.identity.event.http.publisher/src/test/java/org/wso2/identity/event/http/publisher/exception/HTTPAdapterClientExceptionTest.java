...
/**
 * Exception wrapper class for HTTP Adapter exceptions test cases.
 */
public class HTTPAdapterClientExceptionTest {
    ...
    public void testConstructorAndInheritance() {
        ...
        HTTPAdapterClientException exception =
                new HTTPAdapterClientException(message, description, errorCode);
